...
--whan user fill the name and email and click on submit button than a event will run that is - 
--A 4 digit OTP will generate,
--that OTP will store in your Database as the user password and 
-- that OTP will send on the same email address as a email from your(admin) side. 
'''
import random
import string
